...
- the node-to-community assignment variable x,
- objective interpretation as modularity score over same-community pairs,
- separation between structural constraints and optimization target.
